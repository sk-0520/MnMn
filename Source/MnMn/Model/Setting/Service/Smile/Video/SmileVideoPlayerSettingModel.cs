...
namespace ContentTypeTextNet.MnMn.MnMn.Model.Setting.Service.Smile.Video
{
    ...
    public class SmileVideoPlayerSettingModel: SettingModelBase
    {
        ...
        /// </summary>
        [DataMember]
        public bool DisbaledAutoScrollCommentListOverCursor { get; set; } = Constants.SettingServiceSmileVideoPlayerDisbaledAutoScrollCommentListOverCursor;
        ...
        /// <summary>
        /// <see cref="InactiveIsFullScreenRestore"/>の対象をプライマリディスプレイ時でのみ適用するか。
        /// </summary>
        [DataMember]
