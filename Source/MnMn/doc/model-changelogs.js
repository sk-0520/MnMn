				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							...
							'明確な原因特定は出来てないけど、本対応はキャッシュ済み動画を新規プレイヤーを立ち上げるとプログラムが落ちる問題に対応した',
							'キャッシュ不完全なら既存キャッシュ調べたり残りの必要キャッシュサイズ計算したり通信かけたりしている間にプレイヤーUIが構築されたんだけど、キャッシュ済みの場合はそれらを全部スキップして(意味的にはそれでいいんだけど)プレイヤー周りのUI構築が完了してないけどロジック上は再生可能なのでプレイヤーに再生命令を出すけどプレイヤーが無理っすよって言いながら死んで義理堅い MnMn も心中に付き合ってたんじゃないかな',
