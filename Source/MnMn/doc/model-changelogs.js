				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							...
							'動画ソース・音声ソースでどの品質を用いるか重み付で設定するイメージ',
							'仕様も分からん・ソース数も分からん、となるとこの方式しかなかったんよ',
							...
							'あとファインダーでいうところのキャッシュ有無表示はどれか一つのソースでもキャッシュがあれば「あり」判定するので悪いソースでキャッシュ作ってても良いソースが使えるのならダウンロードすることになる'
						]
					}
				]
			},
			{
				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							'妥協と妥協と妥協の産物',
							'思想的なものでもなく互換性でもなくただの実装上都合での妥協ってひさびさ、ﾑｷｰってなるわ'
						]
					},
					{
						'revision': '',
