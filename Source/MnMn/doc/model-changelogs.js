				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							...
							'たとえ部分的にでも私はゼロベースで書き直したスマートで美しくて素晴らしいコードより既に動いているゲロゲロなプログラムがもたらす実績ありっていう最強の信頼度を優先するよ',
							'歳食ったら保守的になるのだ',
							'移植したって言ってもいろいろ変えたし(非同期周りとか)思うところはあるからヤバいときは手動か App.config 書き換えて既存処理使ってね',
