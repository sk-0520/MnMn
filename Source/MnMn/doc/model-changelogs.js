				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							...
							'これ、内部的にはいくら保持してもいいんだけど表示側を考えると制限せざるを得ないのですよ',
							'その理由はかなり昔(2016年の夏のセミ全滅期くらい)に 1000 件から 500 件に変えた時と同じで件数多いとサムネイルやらタグやらで待ち時間がぱねぇ',
							'なので今回は上辺の表示と内部の保持数を分離した(デバッグしてないからミスってて逆だったらめんご)',
							'ここをページャ形式で分割するとして既存処理使い回す前提でも実装がだるい ;-)'
						]
					},
					{
						'revision': '',
