		...
		'contents': [
			{
				...
				'logs': [
					...
					{
						'revision': '',
						'subject': '動画プレイヤーコントロールを更新したけど変な動きだったらすぐ教えてください',
						'comments': [
				...
				'logs': [
					...
					},
					{
						...
						'comments': [
							...
							'通常再生だと別段問題ないんだけど連続再生時に次の動画の音声のみが再生される挙動で頭爆発した',
							'新しい動画再生する際には明示的に停止してそれから再生するコードを組み込んだら大丈夫なったけど全然理屈が分からなくてモヤモヤする',
