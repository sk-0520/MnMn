...
namespace ContentTypeTextNet.MnMn.MnMn.Logic.Service.Smile.Video.Api.V1
{
    public class Tag: SessionApiBase<SmileSessionViewModel>
    {
        ...
        {
            var page = new PageLoader(Mediator, HttpUserAgentHost, SmileVideoMediationKey.tagRelation, ServiceType.SmileVideo);
        ...
        {
            var page = new PageLoader(Mediator, HttpUserAgentHost, SmileVideoMediationKey.tagTrend, ServiceType.SmileVideo);
            return page.GetResponseTextAsync(PageLoaderMethod.Post).ContinueWith(task => {
                page.Dispose();
                var response = task.Result;
        ...
        {
            var page = new PageLoader(Mediator, HttpUserAgentHost, SmileVideoMediationKey.tagFeed, ServiceType.SmileVideo);
