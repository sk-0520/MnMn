...
namespace ContentTypeTextNet.MnMn.MnMn.ViewModel.Controls.NicoNico.Video
{
    public class NicoNicoVideoRankingCategoryItemViewModel: ViewModelBase
    {
        ...
        NicoNicoVideoRankingLoad _rankingLoad;
        ...
        public NicoNicoVideoRankingLoad RankingLoad
        {
        ...
        public bool CanLoad
        {
            get
            {
                var loadSkips = new[] { NicoNicoVideoRankingLoad.RankingListLoading, NicoNicoVideoRankingLoad.RankingListChecking };
        ...
        {
            RankingLoad = NicoNicoVideoRankingLoad.RankingListLoading;
            NowLoading = true;
            var rankingFeedModel = await RestrictUtility.Block(async () => {
                using(var host = new HttpUserAgentHost())
                using(var page = new PageScraping(Mediation, host, NicoNicoVideoMediationKey.ranking, ServiceType.NicoNicoVideo)) {
                    ...
                    if(!rankingXmlResult.IsSuccess) {
                        RankingLoad = NicoNicoVideoRankingLoad.Failure;
                        return null;
                    }

                    RankingLoad = NicoNicoVideoRankingLoad.RankingListChecking;
            ...
            await Task.Run(() => {
                ...
                Task.Run(() => {
                    RankingLoad = NicoNicoVideoRankingLoad.ImageLoading;
                    ...
                    //VideoInformationItems.Refresh();
                    RankingLoad = NicoNicoVideoRankingLoad.Completed;
                    NowLoading = true;
