...
{
    public static class GetthumbinfoUtility
    {
        #region function
        ...
        /// <returns></returns>
        public static bool IsSuccessResponse(RawVideoThumbResponseModel rawModel)
        {
        ...
        public static MovieType ConvertMovieType(string s)
        {
            MovieType result;
            if(Enum.TryParse<MovieType>(s, out result)) {
                return result;
            }
        ...
        public static ThumbType ConvertThumbType(string s)
        {
            ThumbType result;
            if(Enum.TryParse<ThumbType>(s, out result)) {
                return result;
            }

            return ThumbType.Unknown;
        }
        ...
        public static bool IsCategory(RawVideoTagItemModel tag)
        {
            return RawValueUtility.ConvertBoolean(tag.Category);
        }

        public static bool IsLocked(RawVideoTagItemModel tag)
        {
